<template>
	<VCard :outlined="true">
		<VRow>
			...
			<VCol :size="8">
				<VFieldSet>
					<VLabel :on-color="true"> Username </VLabel>
					<VInput type="text" :value="account.username" />
				</VFieldSet>
				<VFieldSet>
					<VLabel :on-color="true"> Email </VLabel>
					<VInput type="email" :value="account.email" />
				</VFieldSet>
			</VCol>
		</VRow>
	</VCard>
...
export default class AccountBasicInfo extends Vue {
	@Inject()
